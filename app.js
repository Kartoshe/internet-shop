...
const allowedOrigins = [
  'http://localhost:5500',
  'http://127.0.0.1:5500',
  process.env.FRONTEND_URL || 'https://internet-shop.onrender.com' // Добавим домен Render
];

app.use(cors({
  origin: (origin, callback) => {
    // Разрешаем запросы без origin (например, от серверных приложений) или из списка
